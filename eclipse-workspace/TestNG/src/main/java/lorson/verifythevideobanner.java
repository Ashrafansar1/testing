...
public class verifythevideobanner {
	 WebDriver driver;
	    WebDriverWait wait;
	    ...
	    public void setup() {
	        ...
	        WebElement imageElement = driver.findElement(By.xpath("//img[@src='https://mcstg-shop.larsonjuhl.com/media/weltpixel/owlcarouselslider/images/d/e/desktop.gif' and @alt='The Making of Artifact']"));
	        imageElement.click();
	    }
}
