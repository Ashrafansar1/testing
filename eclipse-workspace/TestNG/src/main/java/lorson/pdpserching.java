...
public class pdpserching {
    ...
    public void setup() {
        ...
        @Test(priority = 2)
        public void serachingpdp() throws InterruptedException {
        	 WebElement serachingpdp  = driver.findElement(By.xpath("//input[@id='search']\r\n"));
        	 serachingpdp.sendKeys("154BL");
